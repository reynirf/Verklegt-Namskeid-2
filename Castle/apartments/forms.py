...
class ContactInfoForm(forms.Form):
    name = forms.CharField(max_length=255, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'John Doe'}), required=True)
...
class PaymentInfoForm(forms.Form):
    ...
    cardnumber = forms.IntegerField(max_value=9999999999999999, widget=forms.TextInput(attrs={'class': 'form-control', 'type': 'number', 'placeholder': '1234123412341234'}), required=True)
    ...
    years = (('2019', '2019'), ('2020', '2020'),('2021', '2021'),('2022', '2022'),('2023', '2023'),('2024', '2024'),('2025', '2025'),('2026', '2026'),('2027', '2027'),('2028', '2028'),('2029', '2020'))
    ...
    cvc = forms.IntegerField(max_value=9999, widget=forms.TextInput(attrs={'class': 'form-control w-25', 'type': 'number', 'placeholder': '123'}), required=True)